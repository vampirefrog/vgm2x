...
#include <stdint.h>
#include "libfmvoice/opm_voice.h"
...
void opm_voice_collector_push_voice(struct opm_voice_collector *c, struct opm_voice_collector_voice *v, int chan, int midi_note);
